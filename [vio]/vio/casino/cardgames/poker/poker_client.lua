...
function pokerEnterMarkerHit ( hit, dim )
	...
	if hit == lp and dim --[[CHANGEME]] and not getElementData ( lp, "ElementClicked" ) --[[CHANGEME]] then
...
for key, index in pairs ( pokerEnterPlaces["x"] ) do
	...
	local marker = createMarker ( x, y, z, "cylinder", size, 125, 0, 0, 125, getRootElement() )
