...
function setPlayerJoinLiarsDice ( player, id )
	...
	if pos then
		vioSetElementData ( player, "liarsDicePos", pos )
		vioSetElementData ( player, "liarsDiceID", id )
		...
		vioSetElementData ( player, "hideNametag", true )
	else
...
function setPlayerLeaveLiarsDice ( player )
	...
	vioSetElementData ( player, "hideNametag", false )
