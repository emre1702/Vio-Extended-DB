...
function ltr_func ()
	...
	addEventHandler("onClientGUIClick", gButton["LTR2"], setElementData(lp,"newspaper",true), false)
	--addEventHandler("onClientGUIClick", gButton["LTR1"], showEmailSpecialWindow(true,"admin@ltr.de"), false)
end
