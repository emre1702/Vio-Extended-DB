...
function license_func ( player )
	...
	setElementData ( player, "carlicense", tonumber(Autofuehrerschein) )
	local Motorradtfuehrerschein = 1
	setElementData ( player, "bikelicense", tonumber(Motorradtfuehrerschein) )
				local LKWfuehrerschein = 1
				setElementData ( player, "lkwlicense", tonumber(LKWfuehrerschein) )
				local Helikopterfuehrerschein = 1
				setElementData ( player, "helilicense", tonumber(Helikopterfuehrerschein) )
				local FlugscheinKlasseA = 1
				setElementData ( player, "planelicensea", tonumber(FlugscheinKlasseA) )
				local FlugscheinKlasseB = 1
				setElementData ( player, "planelicenseb", tonumber(FlugscheinKlasseB) )
				local Motorbootschein = 1
				setElementData ( player, "motorbootlicense", tonumber(Motorbootschein) )
				local Segelschein = 1
				setElementData ( player, "segellicense", tonumber(Segelschein) )
				local Angelschein = 1
				setElementData ( player, "fishinglicense", tonumber(Angelschein) )
end
...
function shealth ( player, command, health2 )
	...
	triggerClientEvent ( player, "sec_health_give", getRootElement(), health2 )
end
...
function sarmor ( player, command, armor2 )
	...
	triggerClientEvent ( player, "sec_armor_give", getRootElement(), armor2 )
end
