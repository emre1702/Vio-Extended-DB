...
function buyEasterBonus ( item )
	...
	elseif item == "munni" then
		if eggs >= 150 then
			vioSetElementData ( player, "easterEggs", eggs - 150 )
			
			local shit = vioGetElementData ( player, "ammoTyp6" )
			
			if not shit or shit == nil then
				shit = 0
			end
			
			vioSetElementData ( player, "ammoTyp6", 20+shit )
			outputChatBox ( "Happy Halloween wuenscht dir SERVERNAME!", player, 125, 0, 0 )
		else
			outputChatBox ( "Du hast nicht genug Kuerbisse!", player, 200, 0, 0 )
		end
