...
function fireKatjuschaRocketClient_func ( player, veh, id, rID, x2, y2, z2, SAM )
	...
	_G["katjuschaNo"..id.."SAM"..rID.."Rocket"] = createObject ( 3790, 2485.1535644531, -1663.7504882813, 12.540796279907 )
	_G["katjuschaNo"..id.."SAM"..rID.."Marker"] = createMarker ( 2486.3100585938, -1663.8648681641, 12.621975898743, "corona", 2, 255, 255, 255, 255 )
	setElementParent ( _G["katjuschaNo"..id.."SAM"..rID.."Marker"], _G["katjuschaNo"..id.."SAM"..rID.."Rocket"] )
	attachElementsInCorrectWay ( _G["katjuschaNo"..id.."SAM"..rID.."Marker"], _G["katjuschaNo"..id.."SAM"..rID.."Rocket"] )
	local x1, y1, z1 = getElementPosition ( SAM )
	local rX, rY, rZ = getElementRotation ( veh )
	setElementPosition ( _G["katjuschaNo"..id.."SAM"..rID.."Rocket"], x1, y1, z1 )
	setElementRotation ( _G["katjuschaNo"..id.."SAM"..rID.."Rocket"], 180, 30+rY-180, rZ+90 )
	...
	moveObject ( _G["katjuschaNo"..id.."SAM"..rID.."Rocket"], movingTime,  x3, y3, z2 + addHight, 0, -30 --[[, -1*(rZ+90)+findRotation ( x2, y2, x1, y1 ) / 2]] )
...
function katjuschaExplode ( id, rID, player )
	...
	local x, y, z = getElementPosition ( _G["katjuschaNo"..id.."SAM"..rID.."Rocket"] )
	destroyElement ( _G["katjuschaNo"..id.."SAM"..rID.."Rocket"] )
