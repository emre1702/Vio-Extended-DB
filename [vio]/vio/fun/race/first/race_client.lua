...
function defreeze ()
	...
	if frozentimer == 5 then
		...
		if gLabel["DeineZeit"] then
			...
			gLabel["DeineZeit"] = guiCreateLabel(1,0,220,62,"Deine Zeit:",false)
		...
		if gLabel["TotalZeit"] then
			...
			gLabel["TotalTime"] = guiCreateLabel(82,45,171,65,"0:00:0",false)
...
addEventHandler ( "onClientMarkerHit", getRootElement(), raceMarkerHit )