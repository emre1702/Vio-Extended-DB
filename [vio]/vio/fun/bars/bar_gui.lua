barMarkers = {}
 ...
 barMarkers["size"] = {}
  ...
  barMarkers["x"][9], barMarkers["y"][9], barMarkers["z"][9], barMarkers["int"][9], barMarkers["dim"][9], barMarkers["size"][9] = 1138.87109375, -2.30859375, 999.6796875, 12, 0, 1
...
for key, index in pairs ( barMarkers["x"] ) do
	...
	local marker = createMarker ( x, y, z, "cylinder", size, 125, 0, 0, 150 )
