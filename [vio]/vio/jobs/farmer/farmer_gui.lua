function showFarmingWindow ()
	...
	gLabel[3] = guiCreateLabel(174,28,20,17,tostring ( getElementData ( lp, "farmerLVL" ) ), false,gWindow["farmSelection"])
	...
	if getElementData ( lp, "farmerLVL" ) >= 100 then
		txt = "Traktor fahren"
		gLabel[4] = guiCreateLabel(127,106,137,55,"Du musst Pflanzen mit\ndem Traktor ernten\n- dafuer erhaelst du\n12 $ pro Pflanze.",false,gWindow["farmSelection"])
	...
	false )
	if getElementData ( lp, "farmerLVL" ) >= 500 then
