...
for key, index in pairs ( taxiSpawns ) do
	...
	_G["taxi"..key] = createVehicle ( id, x, y, z, 0, 0, rz, "SF-CX 0"..key )
	local veh = _G["taxi"..key]
	setVehicleRespawnPosition ( veh, getElementPosition ( veh ) )
	toggleVehicleRespawn ( veh, true )
	setVehicleRespawnDelay ( veh, 1000*10 )
	setVehicleIdleRespawnDelay ( veh, 1000*60 )
	jobTaxis[veh] = true
	addEventHandler ( "onVehicleEnter", veh, taxiEnter_func )
end
