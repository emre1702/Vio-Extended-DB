...
function showAdminMenue ()
	...
	for id, playeritem in ipairs(getElementsByType("player")) do 
		...
		guiGridListSetItemText ( gGrid["plistadmin"], row, gColumn["adminName"], getPlayerName ( playeritem ), false, false )
		guiGridListSetItemText ( gGrid["plistadmin"], row, gColumn["adminPing"], "  "..tostring(getPlayerPing ( playeritem )), true, false )
	end
