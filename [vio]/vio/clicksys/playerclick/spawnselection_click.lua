...
function fillSpawnPointList ()
	...
	guiGridListSetItemText ( gGrid["availableSpawnPoints"], row, gColumn["spawnPoint"], "Strasse", false, false )
	-- Haus --
	...
	elseif fraktion == 9 then
		...
		row = guiGridListAddRow ( gGrid["availableSpawnPoints"] )
		guiGridListSetItemText ( gGrid["availableSpawnPoints"], row, gColumn["spawnPoint"], "Clubgelaende", false, false )
