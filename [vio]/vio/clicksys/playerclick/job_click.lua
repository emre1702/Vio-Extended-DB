...
function anzeigenJobGui ( btn, state )
	...
	if state == "up" then
		...
		showCursor(false)
		triggerServerEvent ( "cancel_gui_server", getLocalPlayer() )
		outputChatBox ( "Die Position des Arbeitgebers wird dir nun auf der Karte angezeigt. Tippe /job um den Marker zu loeschen.",  0, 125, 0 )
		if jobnr == 1 then
