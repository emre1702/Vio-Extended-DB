...
function showSettingsMenue ()
	...
	if not isElement ( gWindow["settings"] ) then
		...
		gButton["helpMenue"] = guiCreateButton(9,80,101,42,"Hilfemenue",false,gWindow["settings"])
		guiSetAlpha(gButton["helpMenue"],1)
		guiSetFont(gButton["helpMenue"],"default-bold-small")
		...
		addEventHandler ( "onClientGUIClick", gButton["helpMenue"],
			function ()
		...
		gLabel[2] = guiCreateLabel(117,87,162,53,"Hier kannst du Information-\nen über den Server finden.",false,gWindow["settings"])
