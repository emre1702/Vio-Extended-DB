...
function givedrugs ()
	...
	local target = getElementData ( getLocalPlayer(), "curclicked" )
	triggerServerEvent ( "givedrugs", getRootElement(), getLocalPlayer(), "cmd", target, tonumber ( guiGetText ( gEdit["drogenanzahl"] ) ) )
end
