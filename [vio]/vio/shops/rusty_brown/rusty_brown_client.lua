...
function renderDonutInfoText ()
	...
	dxDrawText ( donutMenueTexts.."\nDein Geld: "..getElementData ( lp, "money" ).." $", 1, 1, screenwidth, screenheight, tocolor ( 0, 0, 0 ), 3, "default-bold", "center", "center", true, false )
	dxDrawText ( donutMenueTexts.."\nDein Geld: "..getElementData ( lp, "money" ).." $", 1-3, 1-3, screenwidth-3, screenheight-3, tocolor ( 255, 255, 50 ), 3, "default-bold", "center", "center", false, true )
end